...
//      ("DTLB miss",   () => io.dmem.perf.tlbMiss),
  ...
  csr.io.ygjk_tval := io.rocc.badvaddr_ygjk

  when(io.rocc.interrupt){
    printf(p"${Hexadecimal(csr.io.test.out1)} ${Hexadecimal(csr.io.test.out2)} ${Hexadecimal(csr.io.test.out3)} ${Hexadecimal(csr.io.test.out4)} ${Hexadecimal(csr.io.test.out5)} ${Hexadecimal(csr.io.test.out6)} ${Hexadecimal(csr.io.test.out7)} \n")
  }
...
//    printf(p"****************************************\n")
//    printf(p"decode csr.io.interrupt_cause ${Hexadecimal(csr.io.interrupt_cause)}\n")
//  }
...
//      printf(p"****************************************\n")
//      printf(p"csr.io.cause ${csr.io.cause}\n")
//  }
...
//    encodeVirtualAddress(rob.io.com_xcpt.bits.badvaddr, rob.io.com_xcpt.bits.badvaddr), 100000.U)
...
//    csr.io.tval := Mux(tval_valid,
//      encodeVirtualAddress(rob.io.com_xcpt.bits.badvaddr, rob.io.com_xcpt.bits.badvaddr), ygjk_badvaddr)
